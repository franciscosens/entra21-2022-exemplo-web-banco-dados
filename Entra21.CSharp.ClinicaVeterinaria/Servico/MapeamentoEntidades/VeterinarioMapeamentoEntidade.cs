...
namespace Entra21.CSharp.ClinicaVeterinaria.Servico.MapeamentoEntidades
{
    public class VeterinarioMapeamentoEntidade : IVeterinarioMapeamentoEntidade
    {
        ...
        public void AtualizarCampos(Veterinario veterinario, VeterinarioEditarViewModel viewModel)
        {
            veterinario.Idade = viewModel.Idade;
            veterinario.Salario = viewModel.Salario;
        }
    }
}